...
```{r mean histogram, message = FALSE, echo = FALSE, out.width = 500}
library(ggplot2)
...
```{r mean convergence, echo = FALSE, out.width = 500}
...
```{r variance histogram, echo = FALSE, out.width = 500}
...
```{r variance convergence, echo = FALSE, out.width = 500}
...
```{r distribution q-q, echo = FALSE, out.width = 500}
...
Figure 1
```{r a mean histogram, message = FALSE, eval = FALSE, out.width = 500}
library(ggplot2)
ggplot(sim.results, aes(mean)) + 
    geom_histogram(binwidth = 0.03, fill = "dodgerblue4") +
    labs(x = "Mean", y = "Count", 
...
Figure 2
```{r a mean convergence, eval = FALSE, out.width = 500}
ggplot(sim.results, aes(x = n, y = cum.mean)) +
    geom_line(color = "dodgerblue4") +
    labs(x = "Number of simulations", y = "Cumulative mean",
         caption = "Figure 2. Simulated mean convergence") +
...
Figure 3
```{r a variance histogram, eval = FALSE, out.width = 500}
ggplot(sim.results, aes(variance)) +
    geom_histogram(binwidth = 0.25, fill = "dodgerblue4") +
    labs(x = "Variance", y = "Count",
         caption = "Figure 3. Distribution of the variance of 40 exponentials") +
...
Figure 4
```{r a variance convergence, eval = FALSE, out.width = 500}
ggplot(sim.results, aes(x = n, y = cum.variance)) +
    geom_line(color = "dodgerblue4") +
    labs(x = "Number of simulations", y = "Cumulative variance",
         caption = "Figure 4. Simulated variance convergence") +
...
Figure 5
```{r a distribution q-q, eval = FALSE, out.width = 500}
